				...
				<div class="col-md-4">
                        <div class="card bg-primary text-white mb-3">
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class=" text-white stretched-link" href="payments.php">View Payments</a>
                ...
                <div class="col-md-4">
                        <div class="card bg-success text-white mb-3">
                            ...
                            <div class="card-footer d-flex align-items-left justify-content-between">
                                <a class=" text-white stretched-link" href="borrowers.php">View Borrowers</a>
                                <div class=" text-white">
                    ...
                    <div class="col-md-4">
                        <div class="card bg-danger text-white mb-3">
                            ...
                            <div class="card-footer d-flex align-items-left justify-content-between">
                                <a class=" text-white stretched-link" href="members.php">View Members</a>
                                <div class=" text-white">
                  ...
                  <div class="col-md-4">
                        <div class="card bg-warning text-white mb-3">
                            ...
                            <div class="card-footer d-flex align-items-left justify-content-between">
                                <a class="text-white stretched-link" href="loans.php">View Loan List</a>
                                <div class=" text-white">
