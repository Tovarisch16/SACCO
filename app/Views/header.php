...
<nav id="sidebar" class='mx-lt-1 bg-white' >	 
        ...
        <a href="home" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-home"></i></span> Home</a>
				...
				<a href="members" class="nav-item nav-members"><span class='icon-field'><i class="fa fa-user-friends"></i></span> Members</a>
        <a href="plan" class="nav-item nav-plan"><span class='icon-field'><i class="fa fa-list-alt"></i></span> Loan Plans</a>
				<a href="savings" class="nav-item nav-savings"><span class='icon-field'><i class="fa fa-wallet"></i></span> Savings</a>	
